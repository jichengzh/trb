...
def parse_args():
    ...
    parser.add_argument("--config", type=str, default='./projects/configs/stage2_e2e/b2d_base_imgx0.25_e2e_dump_trt_input.py', help="test config file path")
    parser.add_argument("--dump_folder", type=str, default='./nuscenes_np4' ,help="input meta dump folder")
    parser.add_argument("--dump_trt_path", type=str, default='./nuscenes_np4/uniad_trt_input' ,help="input meta dump path")
    parser.add_argument("--dump_onnx_path", type=str, default='./nuscenes_np4/uniad_onnx_input' ,help="input meta dump path")

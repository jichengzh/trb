...
class PlanningHeadSingleMode_XR(nn.Module):
    def __init__(self,
                 bev_h=200,
                 bev_w=200,
                 embed_dims=256,
        ...
        """
        super(PlanningHeadSingleMode_XR, self).__init__()
    ...
    def forward_test(self, bev_embed, outs_motion=None, outs_occflow=None, command=None, ins_occ_query=None):
        ...
        # 执行主规划前向流程
        outs_planning = self(bev_embed, occ_mask, bev_pos, sdc_traj_query, sdc_track_query, command, ins_occ_query)

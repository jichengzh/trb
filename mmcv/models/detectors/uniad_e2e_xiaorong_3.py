...
class UniAD_XR_Seg(UniADTrack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(UniAD_XR_Seg, self).__init__(**kwargs)
        if seg_head:
...
# =================== 修改 ========================================
    ...
    def forward_test(self,
        ...
        if self.with_seg_head:
            ...
            memory, memory_mask, memory_pos, lane_query, _, lane_query_pos, hw_lvl = result_seg[0]['args_tuple']
...
# =============================== 修改 ======================================================
        ...
        if self.with_planning_head:
            ...
            result_planning = self.planning_head.forward_test(bev_embed, outs_motion, outs_occ, command, lane_query, ins_occ_query)

...
model = dict(
    ...
    motion_head=dict(
        ...
        anchor_info_path='/home/featurize/Bench2DriveZoo/data/others/b2d_motion_anchor_infos_mode6.pkl',
        transformerlayers=dict(
    ...
    planning_head=dict(
        type='PlanningHeadSingleMode_XR',
        embed_dims=256,
        command_dim=6,
...
data_root = "/home/featurize/Bench2DriveZoo/data/bench2drive"
info_root = "/home/featurize/Bench2DriveZoo/data/infos"
map_root = "/home/featurize/Bench2DriveZoo/data/bench2drive/maps"
map_file = "/home/featurize/Bench2DriveZoo/data/infos/b2d_map_infos.pkl"

...
class TCPAgent(autonomous_agent.AutonomousAgent):
	...
	def run_step(self, input_data, timestamp):
		start_inference_time_all = time.perf_counter()
		...
		end_inference_time_all = time.perf_counter()
		all_time = end_inference_time_all - start_inference_time_all
		print('所有时间耗时', all_time)
